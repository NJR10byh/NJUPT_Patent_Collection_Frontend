          ...
          "formList|1-100": [
            {
              ...
              technicalClassification: "@cword(20, 50)",
              achievementIntroduce: "@cword(20, 50)",
              keyTechnologies: "@cword(20, 50)",
              fieldMarket: "@cword(20, 50)",
              achievementPrice: "@float(1,100,1,3)",
    ...
    response: () => ({
      ...
      data: {
        ...Mock.mock({
          ...
          "technicalMaturity|1": ["基本原理", "应用方案", "原理样机", "工程样机", "产业化阶段"],
          technicalClassification: "@cword(20, 50)",
          achievementIntroduce: "@cword(30, 50)",
          keyTechnologies: "@cword(20, 50)",
          fieldMarket: "@cword(20, 50)",
          achievementPrice: "@float(1,100,1,3)",
          transformWay: "技术转让,技术开发,技术咨询",
          createUser: "@cname()",
          createTime: "@date(yyyy-MM-dd) @time(hh:MM:ss)",
          updateUser: "@cname()",
          updateTime: "@date(yyyy-MM-dd) @time(hh:MM:ss)"
